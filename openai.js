...
Return only the key (as a number starting from 0) of the rule that best applies. If no rule applies, return null.`;
...
module.exports = { classifyEmail, createDraftEmail };
